...
public interface IRecursoDao extends CrudRepository<Recurso, Long> {
	...
	@Query("SELECT r from Recurso r where r.tiporecurso.rectipo_codigo <> 'Salon' AND r.tiporecurso.rectipo_codigo <> 'Sala' AND r.tiporecurso.rectipo_codigo <> 'Auditorio' And r.facultad.fac_codigo = ?1 AND r.estado = true")
